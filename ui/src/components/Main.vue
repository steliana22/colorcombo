    ...
    <v-row class="text-center">
      <v-col cols="12" sm="6"  >
        <v-row justify="center" class="orange lighten-4 pa-6 ma-5 rounded-xl">
          <h2 class="headline font-weight-light ma-4 deep-orange--text">Interact with the color collection below</h2>
            ...
            <v-card elevation="10" class="pa-4">
              ...
              <v-card-actions>
                ...
                <v-btn
                  ...
                  text
                  @click="
                    addColor(newColorName, newHexValue);
      ...
      <v-col cols="12" sm="6">
        <v-row justify="center" class="ma-5">
          <div v-for="(col, i) in colors" :key="i" class="d-flex flex-column justify-center align-center ma-3" :style="{color:col.hex}">
            <v-avatar :color="col.hex" size="50" class="mb-2 mt-4"> </v-avatar>
            {{ col.name }}
          </div>
        </v-row>
      </v-col>
